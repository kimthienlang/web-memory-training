...
export default function BoardCaption() {
  ...
  const listContentCaption2: Array<string> = 
    ["How to Develop a Brilliant Memory Week by Week", "How to Develop a Brilliant Memory Week by Week: 50 Proven Ways to Enhance Your Memory Dominic O'Brien", "The method of memorization through images.", "The method of memorization through images.", "The method of memorization through images.",]
  const listContentCaption3: Array<string> = 
    ["You Can Have an Amazing Memory: Learn Life-Changing Techniques and Tips from the Memory Maestro", "The method of memorization through images.", "The method of memorization through images.", "The method of memorization through images.", "The method of memorization through images.",]
